...
def shortest_path(source, target):
    ...
    """
    #initializing - start node, frontier, explored set
    ...
    while True:
        ...
        #check the neighboring nodes to find the solution
        ...
        for movie_id, star_id in neighbors_for_person(node.state):
            if not frontier.contains_state(star_id) and star_id not in explored:
                ...
                #if solution is found, backtrack the path from the newest node and add to path list
